...
<img src="./assets/connected-platform.svg" alt="Familiar ERP, CRM, BPM, HRM, inventory and financial capabilities brought together in Korven, with room for additional organizational domains" width="100%">
...
<img src="./assets/operating-model.svg" alt="Korven connects organization and responsibility, operations and processes, business data and outcomes, and information for decision-making" width="100%">
...
<img src="./assets/connected-workflow.svg" alt="An illustrative connected Korven workflow spanning sales, approval, inventory, production, logistics and finance, with many more configurable business paths" width="100%">
